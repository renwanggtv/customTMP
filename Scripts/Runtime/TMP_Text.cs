...
namespace TMPro
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        protected float[] m_frameRateParameters = new float[16];
                        ...
                        for (int i = 0; i < m_xmlAttribute.Length && m_xmlAttribute[i].nameHashCode != 0; i++)
                        {
                            ...
                            switch (nameHashCode)
                            {
                                ...
                                case 26705: // ANIM
                                    ...
                                    {
                                        int customHashCode = m_xmlAttribute[j].nameHashCode;
                                        int custonIndex = 0;
                                        switch (customHashCode)
                                        {
                                            case 289621: //frame 
                                                int frameRateParamCount = GetAttributeParameters(m_htmlTag, m_xmlAttribute[j].valueStartIndex, m_xmlAttribute[j].valueLength, ref m_frameRateParameters);
                                                break;
                                            default:
                                                if (customHashCode != 2246877 && customHashCode != 1619421 && customHashCode != 39505 && customHashCode != 26705)
                                                    return false;
                                                break;
                                    ...
                                    if (m_isParsingText)
                                    {
                                        ...
                                        spriteAnimator.DoSpriteAnimation(m_characterCount, m_currentSpriteAsset, m_spriteIndex, (int)m_attributeParameterValues[1], (int)m_attributeParameterValues[2], m_frameRateParameters);
                                    }
